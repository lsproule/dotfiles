...
_G.packer_plugins = {
  LuaSnip = {
    ...
    loaded = true,
    needs_bufread = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  ["magma-nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/magma-nvim",
  ...
  ["presenting.vim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/presenting.vim",
  ...
  ["ts-node-action"] = {
    ...
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/ts-node-action",
  ...
  ["vim-import-cost"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vim-import-cost",
    url = "https://github.com/yardnsm/vim-import-cost"
  },
  ["vim-jukit"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vim-jukit",
    url = "https://github.com/luk400/vim-jukit"
  },
  ["vim-kubernetes"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vim-kubernetes",
