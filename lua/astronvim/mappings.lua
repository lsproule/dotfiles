...
-- Normal --
-- Standard Operations
maps.n["r"] = { "<cmd>w ! python3<cr>", desc = "run python" }
...
maps.n["|"] = { "<cmd>split<cr>", desc = "Vertical Split" }
...
maps.n["<leader>bC"] = { function() require("astronvim.utils.buffer").close_all() end, desc = "Close all buffers" }
maps.n["<leader>bn"] = { vim.cmd.bnext, desc = "Close all buffers" }
maps.n["<leader>bp"] = { vim.cmd.bprevious, desc = "Close all buffers" }
maps.n["<leader>bb"] = {
  function()
...
maps.n["<leader>ha"] = { function() require("harpoon.mark").add_file() end }
maps.n["<leader>hu"] = { function() require("harpoon.ui").toggle_quick_menu() end }
  ...
  maps.n["<leader>n"] = {
    function()
      if vim.bo.filetype == "neo-tree" then
        ...
        vim.cmd "Neotree source=filesystem dir=~/wrk"
      end
    end,
    desc = "Toggle Explorer Focus",
  }
...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>fmc"] = { function() require("telescope.builtin").man_pages() end, desc = "Find man" }
  maps.n["<leader>fmd"] =
    { function() require("telescope.builtin").man_pages { sections = { "2", "3" } } end, desc = "Find man" }
  ...
  maps.n["<leader>fg"] = { function() require("telescope.builtin").live_grep() end, desc = "Find grep" }
  maps.n["<leader>fW"] = {
    function()
